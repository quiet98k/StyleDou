...
if __name__ == '__main__':
    ...
    log_path = os.path.join(log_dir, 'WP_test.log')
    csv_path = os.path.join(log_dir, 'wp_eval.csv')
    ...
    os.system("".join([
        ...
        " --landlord ",
        landlord_ckpt,
        " --landlord_up baseline_WP",
        " --landlord_down baseline_WP",
        " --eval_data ",
        eval_data_path,
        " --csv_path ",
        csv_path,
