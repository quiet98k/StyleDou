...
parser = argparse.ArgumentParser(
    description="DouZero Style Modeling: PyTorch DouDizhu AI"
)
...
parser.add_argument(
    "--xpid",
    default="style_model",
    help="Experiment id (default: style_model)",
)
parser.add_argument(
    "--save_interval",
    default=30,
...
parser.add_argument(
    "--savedir",
    default="douzero_checkpoints/style",
...
# Style modeling settings.
parser.add_argument(
    "--aux_loss_weight",
    default=0.2,
    type=float,
    help="Weight for opponent-action auxiliary loss",
)
parser.add_argument(
    "--style_embed_dim",
    default=64,
    type=int,
    help="Hidden size for opponent style encoder",
)
parser.add_argument(
    "--history_embed_dim",
    default=128,
    type=int,
    help="Hidden size for public action history encoder",
)
...
parser.add_argument(
    ...
    type=str,
    help="Optional directory containing bootstrap weights for style training",
)
parser.add_argument(
    "--run_eval_on_checkpoint",
    action="store_true",
    help="Run ADP/SL/WP tests when checkpoints are saved",
)
parser.add_argument(
    "--eval_num_games",
    default=10000,
